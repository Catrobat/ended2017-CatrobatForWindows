...
namespace Catrobat.IDE.Store.Controls.ListPicker
{
    public partial class ListPicker : UserControl
    {
        ...
        public static readonly DependencyProperty ItemsSourceProperty = DependencyProperty.Register(
            "ItemsSource", typeof(IList), typeof(ListPicker), new PropertyMetadata(default(IList), ItemsSourcePropertyChangedCallback));
        ...
        public static readonly DependencyProperty PageItemTemplateProperty = DependencyProperty.Register(
            "PageItemTemplate", typeof(DataTemplate), typeof(ListPicker), new PropertyMetadata(default(DataTemplate), PageItemTemplatePropertyChangedCallback));
        ...
        public static readonly DependencyProperty NullItemProperty = DependencyProperty.Register(
            "NullItem", typeof(object), typeof(ListPicker), new PropertyMetadata(default(object), NullItemPropertyChanged));
