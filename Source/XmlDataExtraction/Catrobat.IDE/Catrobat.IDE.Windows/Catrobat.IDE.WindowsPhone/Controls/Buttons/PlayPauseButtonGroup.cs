...
namespace Catrobat.IDE.WindowsPhone.Controls.Buttons
{
    public class PlayPauseButtonGroup : FrameworkElement
    {
        ...
        public static readonly DependencyProperty CommandProperty = DependencyProperty.Register("Command", typeof(ICommand), typeof(PlayPauseButtonGroup), new PropertyMetadata(null, CommandChanged));
