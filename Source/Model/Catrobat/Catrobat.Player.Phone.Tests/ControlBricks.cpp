...
//			BroadcastScript *broadcastScript = new BroadcastScript(broadcastMessage, object);
...
//
//			StartScript *script = new StartScript(object);
//			BroadcastScript *broadcastScript = new BroadcastScript(expectedMessage, object);
//			broadcastScript->AddBrick(new SetSizeToBrick(spriteReference, formulaTree, broadcastScript));
//
//			BroadcastBrick *brick = new BroadcastBrick(spriteReference, broadcastMessage, script);
//
...
//
//			StartScript *script = new StartScript(object1);
//			BroadcastScript *broadcastScript = new BroadcastScript(broadcastMessage, object2);
//			broadcastScript->AddBrick(new SetSizeToBrick(spriteReference, formulaTree, broadcastScript));
//
//			BroadcastBrick *brick = new BroadcastBrick(spriteReference, broadcastMessage, script);
//
...
//
//			StartScript *script = new StartScript(object1);
//			BroadcastScript *broadcastScript = new BroadcastScript(expectedMessage, object2);
//			broadcastScript->AddBrick(new SetSizeToBrick(spriteReference, formulaTree, broadcastScript));
//
//			BroadcastBrick *brick = new BroadcastBrick(spriteReference, broadcastMessage, script);
//
...
//			BroadcastScript *broadcastScript2 = new BroadcastScript(expectedMessage2, object1);
...
//
//			StartScript *script = new StartScript(object);
//            IfBrick *brick = new IfBrick(formulaTree, script);
//
