...
{
    [TestClass]
    public class ProgramExportViewModelTests
    {
        [ClassInitialize]
        ...
        public void UploadToPocketCodeOrgActionTest()
        {
            ...
            navigationService.CurrentView = typeof(ProgramExportViewModel);

            var viewModel = new ProgramExportViewModel();
            ...
            viewModel.UploadToPocketCodeOrgCommand.Execute(null);
