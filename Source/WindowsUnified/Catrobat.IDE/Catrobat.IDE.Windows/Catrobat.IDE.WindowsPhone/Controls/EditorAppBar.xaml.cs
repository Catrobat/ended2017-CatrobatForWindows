...
namespace Catrobat.IDE.WindowsPhone.Controls
{
    ...
    public partial class EditorAppBar : UserControl
    {
        ...
        public static readonly DependencyProperty NumberOfSelectedItemsProperty = 
            DependencyProperty.Register("NumberOfSelectedItems", typeof(int), typeof(EditorAppBar), new PropertyMetadata(0, NumberOfSelectedItemsChanged));
        ...
        public static readonly DependencyProperty ClearSelectionCommandProperty =
            DependencyProperty.Register("ClearSelectionCommand", typeof(ICommand), typeof(EditorAppBar), new PropertyMetadata(null, ClearSelectionCommandChanged));
        ...
        public static readonly DependencyProperty CopyCommandProperty =
            DependencyProperty.Register("CopyCommand", typeof(ICommand), typeof(EditorAppBar), new PropertyMetadata(null, CopyCommandChanged));
        ...
        public static readonly DependencyProperty EditCommandProperty =
            DependencyProperty.Register("EditCommand", typeof(ICommand), typeof(EditorAppBar), new PropertyMetadata(null, EditCommandChanged));
        ...
        public static readonly DependencyProperty DeleteCommandProperty =
            DependencyProperty.Register("DeleteCommand", typeof(ICommand), typeof(EditorAppBar), new PropertyMetadata(null, DeleteCommandChanged));
        ...
        public static readonly DependencyProperty NewCommandProperty = 
            DependencyProperty.Register("NewCommand", typeof(ICommand), typeof(EditorAppBar), new PropertyMetadata(null, NewCommandChanged));
        ...
        public static readonly DependencyProperty PlayCommandProperty =
            DependencyProperty.Register("PlayCommand", typeof(ICommand), typeof(EditorAppBar), new PropertyMetadata(null, PlayCommandChanged));
