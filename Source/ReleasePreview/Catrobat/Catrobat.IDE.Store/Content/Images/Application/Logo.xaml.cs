...
namespace Catrobat.IDE.Store.Content.Images.Application
{
    public partial class Logo : UserControl
    {
        ...
        public static readonly DependencyProperty TextVisibilityProperty = DependencyProperty.Register(
            "TextVisibility", typeof(Visibility), typeof(Logo), new PropertyMetadata(Visibility.Collapsed, TextVisibilityChanged));
