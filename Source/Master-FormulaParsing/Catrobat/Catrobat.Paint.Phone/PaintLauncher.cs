...
namespace Catrobat.Paint.Phone
{
    public static class PaintLauncher
    {
        ...
        public static void Launche(PaintLauncherTask task)
        {
            ...
            ((PhoneApplicationFrame)Application.Current.RootVisual).Navigate(new Uri("/Catrobat.Paint.Phone;component/View/PaintingAreaView.xaml", UriKind.RelativeOrAbsolute));
        }
    }
