...
namespace Catrobat.IDE.Store.Content.Images.Misc
{
    public partial class ImageGallery : UserControl
    {
        ...
        public static readonly DependencyProperty ScaleFactorProperty = DependencyProperty.Register("ScaleFactor", 
            typeof(double), typeof(ImageGallery), new PropertyMetadata(0.0, ScaleFactorChanged));
