...
namespace Catrobat.IDE.WindowsShared.Content.Images.Misc
{
    public partial class ImageGallery : UserControl
    {
        ...
        public static readonly DependencyProperty ScaleFactorProperty = DependencyProperty.Register("ScaleFactor", typeof(double), typeof(ImageGallery), new PropertyMetadata(0.0, ScaleFactorChanged));

        private static void ScaleFactorChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var canvas = ((ImageGallery)d).Main;
