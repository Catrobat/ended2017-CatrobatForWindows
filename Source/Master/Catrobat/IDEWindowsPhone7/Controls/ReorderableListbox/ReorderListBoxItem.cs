...
namespace Catrobat.IDEWindowsPhone7.Controls.ReorderableListbox
{
    ...
    /// </summary>
    [TemplatePart(Name = ReorderListBoxItem.DragHandlePart, Type = typeof(ContentControl))]
    ...
    public class ReorderListBoxItem : ListBoxItem
    {
        ...
        /// </summary>
        public ContentControl DragHandle
        {
            get;
            private set;
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            this.DragHandle = this.GetTemplateChild(ReorderListBoxItem.DragHandlePart) as ContentControl;
