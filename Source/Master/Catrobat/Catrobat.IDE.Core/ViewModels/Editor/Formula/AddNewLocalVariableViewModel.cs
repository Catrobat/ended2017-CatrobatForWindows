...
namespace Catrobat.IDE.Core.ViewModels.Editor.Formula
{
    public class AddNewLocalVariableViewModel : ViewModelBase
    {
        ...
        {
            VariableHelper.AddLocalVariable(CurrentProject, SelectedSprite, new LocalVariable{ Name = UserVariableName });
            base.GoBackAction();
        }
        ...
        {
            UserVariableName = AppResources.Editor_DefaultLocalVariableName;
        }
    }
}
