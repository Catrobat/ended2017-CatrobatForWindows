    ...
    public class CopyTests
    {
        ...
        public void CopySprite()
        {
...

            {
                ...
                Assert.IsNotNull(newStartScript);
...

            {
                ...
                using (IStorage storage = StorageSystem.GetStorage())
                {
                    Assert.IsTrue(storage.FileExists(pathCostumes + sprite2.Costumes.Costumes[0].FileName));
                    Assert.IsTrue(storage.FileExists(pathCostumes + newSprite2.Costumes.Costumes[0].FileName));
                    Assert.IsTrue(storage.FileExists(pathCostumes + sprite2.Costumes.Costumes[1].FileName));
                    Assert.IsTrue(storage.FileExists(pathCostumes + newSprite2.Costumes.Costumes[1].FileName));
                }
                ...
                using (IStorage storage = StorageSystem.GetStorage())
                {
                    Assert.IsTrue(storage.FileExists(pathSounds + soundInfo1.FileName));
                    Assert.IsTrue(storage.FileExists(pathSounds + newSoundInfo1.FileName));
                    Assert.IsTrue(storage.FileExists(pathSounds + soundInfo2.FileName));
                    Assert.IsTrue(storage.FileExists(pathSounds + newSoundInfo2.FileName));
                }
            }
            {
