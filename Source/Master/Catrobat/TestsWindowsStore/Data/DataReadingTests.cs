...
namespace TestsWindowsStore.Data
{
  ...
  public class DataReadingTests
  {
    ...
    public void ReadSimpleTest()
    {
      ...
      //  Assert.AreEqual(sprite1.CostumeList.Costumes.Count, 1);
      //  Assert.AreEqual(sprite1.Name, "Background");

      //  Assert.AreEqual(sprite1.CostumeList.Costumes[0].Name, "background");
      //  Assert.AreEqual(sprite1.CostumeList.Costumes[0].FileName, "3F3C722FCCBBD45ACF1211E3155FD5C6_background");

      //  var startScript = sprite1.ScriptList.Scripts[0] as StartScript;

      //  Assert.AreEqual(startScript.BrickList.Bricks.Count, 1);

      //  var brick = startScript.BrickList.Bricks[0] as SetCostumeBrick;
      //  Assert.AreEqual(brick.CostumeReference.Reference, "../../../../../costumeDataList/costumeData");
      //  Assert.AreEqual(brick.Costume, sprite1.CostumeList.Costumes[0]);

      //  Assert.AreEqual(sprite1.SoundList.Sounds.Count, 0);
      //}

      //{
      //  var sprite2 = project.SpriteList.Sprites[1];
      //  var costumeList = sprite2.CostumeList;
      ...
      //  var brick1 = startScript.BrickList.Bricks[0] as SetCostumeBrick;
      ...
      //  Assert.AreEqual(whenScript.BrickList.Bricks.Count, 5);
      //  Assert.AreEqual(whenScript.Action, WhenScript.WhenScriptAction.Tapped);

      //  var brick2 = whenScript.BrickList.Bricks[0] as SetCostumeBrick;
      //  Assert.AreEqual(brick2.CostumeReference.Reference, "../../../../../costumeDataList/costumeData[2]");
      //  Assert.AreEqual(brick2.Costume, costume2);

      //  var brick3 = whenScript.BrickList.Bricks[1] as WaitBrick;
      //  Assert.AreEqual(brick3.TimeToWaitInMilliSeconds, 500);

      //  var brick4 = whenScript.BrickList.Bricks[2] as SetCostumeBrick;
      //  Assert.AreEqual(brick4.CostumeReference.Reference, "../../../../../costumeDataList/costumeData[3]");
      //  Assert.AreEqual(brick4.Costume, costume3);

      //  var brick5 = whenScript.BrickList.Bricks[3] as WaitBrick;
      //  Assert.AreEqual(brick5.TimeToWaitInMilliSeconds, 500);

      //  var brick6 = whenScript.BrickList.Bricks[4] as SetCostumeBrick;
      //  Assert.AreEqual(brick6.CostumeReference.Reference, "../../../../../costumeDataList/costumeData");
      //  Assert.AreEqual(brick6.Costume, costume1);

      //  Assert.AreEqual(sprite2.SoundList.Sounds.Count, 0);
      //}
    }
    ...
    public void ReadUltimateTest()
    {
      ...
      //{
      //  Assert.AreEqual(sprite1.CostumeList.Costumes.Count, 1);
      //  Assert.AreEqual(sprite1.CostumeList.Costumes[0].Name, "Hintergrund");
      //  Assert.AreEqual(sprite1.CostumeList.Costumes[0].FileName, "B978398F6E8D16B857AA81618F3EF879_Hintergrund");

      //  Assert.AreEqual(sprite1.Name, "Hintergrund");

      //  Assert.AreEqual(sprite1.ScriptList.Scripts.Count, 1);
      //  var startScript = sprite1.ScriptList.Scripts[0] as StartScript;

      //  Assert.AreEqual(startScript.BrickList.Bricks.Count, 23);
      ...
      //  Assert.AreEqual(brick12.DurationInMilliSeconds, 1000);
      ...
      //  Assert.AreEqual(brick13.Costume, sprite1.CostumeList.Costumes[0]);
      ...
      //{
    //    Assert.AreEqual(sprite2.CostumeList.Costumes.Count, 2);
    //    Assert.AreEqual(sprite2.CostumeList.Costumes[0].Name, "IMG_20120727_130526");
    //    Assert.AreEqual(sprite2.CostumeList.Costumes[0].FileName, "9CC1F04E1A241687B199E4D189E13843_IMG_20120727_130526.jpg");
    //    Assert.AreEqual(sprite2.CostumeList.Costumes[1].Name, "IMG_20120727_130526_Kopie");
    //    Assert.AreEqual(sprite2.CostumeList.Costumes[1].FileName, "9CC1F04E1A241687B199E4D189E13843_IMG_20120727_130526.jpg");

    //    Assert.AreEqual(sprite2.Name, "Sound");
    //    Assert.AreEqual(sprite2.ScriptList.Scripts.Count, 4);

    //    var startScript = sprite2.ScriptList.Scripts[0] as StartScript;

    //    Assert.AreEqual(startScript.BrickList.Bricks.Count, 3);
    ...
    //    Assert.AreEqual(brick1.Sound, sprite2.SoundList.Sounds[0]);
    ...
    //    Assert.AreEqual(brick2.Sound, sprite2.SoundList.Sounds[0]);
    ...
    //    Assert.AreEqual(brick3.Sound, sprite2.SoundList.Sounds[1]);

    //    var whenScript = sprite2.ScriptList.Scripts[1] as WhenScript;

    //    Assert.AreEqual(whenScript.BrickList.Bricks.Count, 7);
    ...
    //    Assert.AreEqual(brick8.TimeToWaitInMilliSeconds, 1000);
    ...
    //    Assert.AreEqual(broadcastScript1.BrickList.Bricks.Count, 6);
    ...
    //    Assert.AreEqual(brick11.LoopEndBrick, broadcastScript1.BrickList.Bricks[3]);
    ...
    //    Assert.AreEqual(brick12.LoopEndBrick, broadcastScript1.BrickList.Bricks[5]);
    ...
    //    Assert.AreEqual(brick14.LoopBeginBrick, broadcastScript1.BrickList.Bricks[0]);
    ...
    //    Assert.AreEqual(brick16.LoopBeginBrick, broadcastScript1.BrickList.Bricks[1]);
    ...
    //    Assert.AreEqual(broadcastScript2.BrickList.Bricks.Count, 0);
    ...
    //  }
    //  {
    //    Assert.AreEqual(sprite3.CostumeList.Costumes.Count, 0);
    //    Assert.AreEqual(sprite3.Name, "Robot");
    //    Assert.AreEqual(sprite3.ScriptList.Scripts.Count, 1);

    //    var startScript = sprite3.ScriptList.Scripts[0] as StartScript;

    //    Assert.AreEqual(startScript.BrickList.Bricks.Count, 5);
    ...
    //    Assert.AreEqual(brick5.DurationInMs, 1000);
    //    Assert.AreEqual(brick5.Hertz, 2800);

    //    Assert.AreEqual(sprite3.SoundList.Sounds.Count, 0);
    //  }
    }
  }
}
