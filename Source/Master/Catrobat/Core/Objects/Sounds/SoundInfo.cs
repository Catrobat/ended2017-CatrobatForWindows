...
{
    public class SoundInfo : DataObject
    {
        ...
        public SoundInfo(string name, Sprite parent)
        {
            this.name = name;
        ...
        internal SoundInfo(XElement xElement, Sprite parent)
        {
            sprite = parent;
        ...
        {
            var newSoundInfo = new SoundInfo(name, parent);
